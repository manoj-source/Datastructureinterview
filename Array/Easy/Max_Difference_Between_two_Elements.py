# Leetcode 216: Maximum difference between Increasing Elements

#            Given a 0-indexed integer array nums of size n, find the maximum difference between nums[i] and nums[j]
#   (i.e., nums[j] - nums[i]), such that 0 <= i < j < n and nums[i] < nums[j]. Return the maximum difference. If no such
#   i and j exists, return -1.
...
def max_difference_between_elements(arr):
    min_element = arr[0]
    max_diff = -1
...
print(max_difference_between_elements([7, 1, 5, 4]))
print(max_difference_between_elements([9, 4, 3, 2]))
print(max_difference_between_elements([1, 5, 2, 10]))
